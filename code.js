  ...
  data.forEach((project) => {
    ...
    <div class="project_info">
      ...
      <div class="project_links">
        <a href="${project.hrefGithub}" title="Github" target="_blank" rel="noreferrer" aria-label="link to ${project.title} github repository">
        ...
        <a href="${project.hrefWeb}" title="Web" target="_blank" rel="noreferrer" aria-label="link to ${project.title} website">
          <svg class="project_link_svg" fill="currentColor" viewBox="0 0 24 24">
            <path
