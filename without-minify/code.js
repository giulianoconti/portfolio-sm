      ...
      <div class="project_info">
        ...
        <div class="project_links">
          <a class="project_link" href="${
            project.hrefGithub
          }" title="Github" target="_blank" rel="noreferrer" aria-label="${languages[lang].projects.github}">
          ...
          ${
            project.hrefWeb
              ? `
              <a class="project_link" href="${project.hrefWeb}" title="Web" target="_blank" rel="noreferrer" aria-label="${languages[lang].projects.web}">
                <svg class="project_link_svg" fill="currentColor" viewBox="0 0 24 24">
                  <path
